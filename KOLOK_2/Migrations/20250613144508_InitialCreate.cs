        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NumberOfArtworks = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1981, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "John", "Doe" },
                    { 2, new DateTime(1982, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "James", "Doe" },
                    { 3, new DateTime(1983, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Jane", "Doe" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1999, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gallery 1" },
                    { 2, new DateTime(1999, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gallery 2" },
                    { 3, new DateTime(1999, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Gallery 3" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1999, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), 1, 2, new DateTime(1999, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Title 1" },
                    { 2, new DateTime(1999, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), 2, 2, new DateTime(1999, 1, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Title 2" },
                    { 3, new DateTime(1999, 1, 4, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 2, new DateTime(1999, 1, 3, 0, 0, 0, 0, DateTimeKind.Unspecified), "Title 3" }
                });
